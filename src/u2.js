...
foam.CLASS({
  ...
  methods: [
      ...
      var f = function templateOut(/* arguments */) {
        for ( var i = 0 ; i < arguments.length ; i++ ) {
          ...
          if ( o === null || o === undefined ) {
            ...
            buf.push(o);
          } else if ( foam.u2.Element.isInstance(o) || self.Entity.isInstance(o) ) {
            o.output(f);
          } else {
    ...
    function validateClass(cls) {
      return this.validator.validateClass(name);
    },
    ...
    function validateAttributeValue(value) {
      return this.validator.validateAttributeValue(name);
    },
    ...
    function validateStyleValue(value) {
      return this.validator.validateStyleValue(name);
    },
    ...
    function removeEventListener_(topic, listener) {
      if ( ! topic.startsWith('on') ) topics = 'on' + topic;
